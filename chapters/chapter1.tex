...
Los sistemas de comunicaciones digitales implementados en su  mayor parte por software se les conocen como SDR (Radio
...
soluci\'on de problemas que requieren un conocimiento multidisciplinario. Adem\'as proporciona al estudiante el conocimiento de una plataforma flexible que le permita en el futuro investigar otros temas no incluidos en el curso tradicional de comunicaciones digitales, sin requerir de un equipo especializado.

Con esto, la importancia de este estudio se vuelve
m\'as evidente cuando el alumno que utilice esta plataforma pueda llevar sus conocimientos b\'asicos a la pr\'actica e implementar un sistema de comunicaciones completo de una manera r\'apida y sencilla.
