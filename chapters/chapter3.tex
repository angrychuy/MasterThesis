...
\DTsetlength{0.2em}{3em}{0.2em}{0.4pt}{1.6pt} %offset, width, sep, rule-width, dot-size
	\dirtree{%
	.1 gnuradio-examples.
	.2 c++.
	.3 dial\_tone.
...
El experimento se bas\'o en los ejemplos del directorio \emph{digital}. El programa implementa un
