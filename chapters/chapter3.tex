...
\end{tikzpicture}
\vspace{0.5in}
\caption{Relaci\'on de modulos del ejemplo \emph{benchmark} de \gnuradio}
\label{fig:relbench}
\end{figure}

El modulo \verb|benchmark_tx| es el principal y es el que el usuario ejecuta para arrancar la
...
empaquetar los bits que se desean transmitir. Esta operaci\'on se explicar\'a a fondo mas adelante.
