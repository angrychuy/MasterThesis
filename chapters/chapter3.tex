...
aplicaci\'on \verb|benchmark_tx.py| muestra una forma de utilizarlos que consiste en codificar y
formatear la informaci\'on en paquetes antes de ser modulados como se muestra en la figura
\ref{fig:grqpsk}. 
