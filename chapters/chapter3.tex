...
unicamente por un bit para minimizar la taza de error de bits. Esta codificaci\'on es opcional y se
puede deshabilitar si no se desea utilizar. 
...
especific\'o, en este caso $M=4$, y luego son introducidos a un filtro de coseno elevado para
reducir la cantidad de ancho de banda requerida para transmitirlos.
