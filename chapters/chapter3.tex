...
%FIXME: Reacer la imagen con leyendas mas grandes
\begin{figure}[pt]
\centering
...
%TODO: Investigar si es n-(N-1)/2 o n=(N-1)/2
\begin{equation}
h(n)=\left\{
\begin{array}{l l}
...
\begin{figure}[htp]
  ...
  \vspace{0.3in}
  \caption{Estructuras b\'asicas de filtros multi tasa.}
  \label{fig:multirate}
\end{figure}
...
\begin{figure}[htp]
  ...
  \end{tikzpicture}
  \vspace{0.3in}
  \caption{Descomposici\'on del filtro decimador en su representaci\'on polif\'asica.}
  \label{fig:polydecim}
\end{figure}
