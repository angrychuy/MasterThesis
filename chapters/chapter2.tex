...
%TODO: Insert reference to new book (spanish book)
...
\end{tikzpicture}
  \vspace{0.3in}
  \caption{Diagrama a bloques del sincronizador del lazo de costas. \protect\cite{perez}}
  \label{fig:costas}
\end{figure}
...
discusi\'on matematica de este sincronizador esta fuera del alcanse de este trabajo pero se invita al lector a consultar la
bibliografia si desea aprender mas sobre la composicion y funcionamiento interno de este y otros sincronizadores. 
