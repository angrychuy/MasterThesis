...
Para poder realizar la sincronizcion de fase se pueden emplear circuitos basados en lazos de amarre de fase (PLL por sus siglas
...
%TODO: Explicar que significa y with hat. Get this sorted out with the Doc
...
El sincronizador requiere que previamente se haya realizado la recuperacion de la fase ya que el algoritmo es muy sencible a offsets en la portadora. La
