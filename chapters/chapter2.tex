...
en ingles \emph{phase-locked loop}). Dos circuitos comunes son el circuito cuadrado y el lazo de costas. El diagrama a bloques
representativo del circuito cuadrado se muestra en la figura \ref{fig:ccuad}.
...
\centering
    ...
    \end{tikzpicture}
    \vspace{0.3in}
    \caption{Diagrama a bloques del circuito cuadrado.}
    \label{fig:ccuad}
\end{figure}
...
\end{tikzpicture}
  \vspace{0.3in}
  \caption{Diagrama a bloques del sincronizador del lazo de costas.}
  \label{fig:costas}
\end{figure}
