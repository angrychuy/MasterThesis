...
\begin{figure}[htp]
  \centering
  \subfloat[$\beta=0.35$]{\label{fig:eye35}\includegraphics[scale=0.36]{figs/ojo35}}
  \subfloat[$\beta=0.50$]{\label{fig:eye50}\includegraphics[scale=0.36]{figs/ojo50}}\\
  \subfloat[$\beta=0.75$]{\label{fig:eye75}\includegraphics[scale=0.36]{figs/ojo75}}
  \vspace{0.3in}
