...
datos son modulados con el esquema DQPSK como est\'a implementado en \emph{GNURadio}. Posteriormente se
observ\'o los resultados utilizando las herramientas proporcionadas por \gnuradio y el lenguaje \emph{Python}. El c\'odigo base
...
gr\'aficas que se pueden utilizar para crear interfaces de usuario que permitan formar aplicaciones desde sencillas hasta
complejas.
...
%TODO: Buscar como poner acentos en lstlisting
...
%TODO: Hacer estas graficas con leyendas mas grandes
\begin{figure}[htp]
  \centering
...
%TODO: Preguntar al doc si es necesario especificar cuantas transmisiones se realizaron.
...
%TODO: Quitarle el cursor a la imagen (fotoshop)
\begin{figure}[htp]
  \centering
