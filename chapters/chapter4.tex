...
\begin{itemize}
  ...
  dentro del paquete \verb|blks2|. Su uso se muestra en el listado. La clase toma la se\~nal
  filtrada e inicia el proceso de demodulaci\'on y detecci\'on. Los resultados son una serie de bits
  desempaquetados, osea, bits individuales.
  %FIXME: Referenciar el listado del codigo final del analisis (main).
