...
resultados se muestran en la figura \ref{fig:berpoly}.
...
Como se puede observar, los filtros polif\'asicos ofrecen una mejora en el rendimiento de ambos
esquemas. A niveles bajos de SNR DQPSK tiene un poco mas de tolerancia que la versi\'on anterior
para generar errores. Con estos se demuestra el rendimiento del c\'odigo fuente actual de
\emph{GNURadio}. El c\'odigo del programa principal se muestra en el listado \ref{ex:mainber}.
